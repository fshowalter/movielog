...
from movielog.internal import imdb_http, movies
...
class PersonBase(Base):  # noqa: WPS214
    ...
    def refresh_item_titles(self) -> None:  # noqa: WPS231
        ...
        logger.log(
            "==== Begin refreshing {0} credits for {1}...", credit_key, self.name,
        )
