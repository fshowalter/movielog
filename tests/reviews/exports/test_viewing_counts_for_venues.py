...
def test_exports_viewing_counts_for_venues(tmp_path: str) -> None:
    ...
    with open(
        os.path.join(tmp_path, "viewing_counts_for_venues", "2016.json"), "r"
    ) as file2016:
    ...
    with open(
        os.path.join(tmp_path, "viewing_counts_for_venues", "2017.json"), "r"
    ) as file2017:
    ...
    with open(
        os.path.join(tmp_path, "viewing_counts_for_venues", "all.json"), "r"
    ) as file_all:
